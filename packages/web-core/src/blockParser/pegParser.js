...
function peg$parse(input, options) {
  ...
  var peg$c35 = function (depth, content) {
    const loc = location();
  ...
  var peg$c46 = peg$otherExpectation('end of line');
  var peg$c47 = '\n';
