...
function peg$parse(input, options) {
  ...
  var peg$e11 = peg$classExpectation(["'", '_', '_', "'"], true, false);
  ...
  var peg$f5 = function (before, tag) {
    return [before, tag];
  };
  ...
  var peg$f12 = function (depth, content) {
    const loc = location();
  ...
  var peg$f14 = function (content, ending) {
    const loc = location();
