...
export { BlockView } from './src/apps/VaultApplication/BlocksExtension/models/BlockView';
...
export * from './src/apps/VaultApplication/BlocksExtension/models/BlockView';
